    ...
    public class ChaparralProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.frameCounter >= 28)
            {
                ...
                int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, velocity.X, velocity.Y, ProjectileID.Stinger, projectile.damage, projectile.owner, 0, 0f);
