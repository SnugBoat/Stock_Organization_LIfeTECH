...
namespace SpiritMod.Items.ElementalBows
{
    public class Quasar : ModItem
    {
        ...
        {
            Projectile.NewProjectile(position.X, position.Y, speedX, speedY, ProjectileID.LostSoulFriendly, damage, knockBack, player.whoAmI, 0f, 0f);
            return false;
