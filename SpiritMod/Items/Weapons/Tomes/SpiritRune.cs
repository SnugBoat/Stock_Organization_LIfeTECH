...
namespace SpiritMod.Items.Weapons.Tomes
{
	public class SpiritRune : ModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
            ...
            Projectile.NewProjectile(position.X, position.Y, speedX + angle, speedY + Main.rand.Next(-1, 1), mod.ProjectileType("Rune"), damage, knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
	}
}